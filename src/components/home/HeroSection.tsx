...
export const HeroSection: React.FC = () => {
  return (
    <div className="text-center mb-8 sm:mb-12 px-4">
      <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white border border-[#e5e7eb] rounded-full mb-6 sm:mb-8 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
        <span className="w-2 h-2 bg-[#40ABA5] rounded-full" />
        <span className="text-[#4b5563] text-xs sm:text-sm font-medium">
          Análisis en tiempo real de medios canarios
        </span>
      </div>

      <h1 className="text-[clamp(32px,8vw,72px)] font-bold leading-tight mb-4 sm:mb-6">
      ...
      <p className="text-base sm:text-xl text-[#6b7280] max-w-[600px] mx-auto mb-2 px-2">
        Descubre en segundos si tu comunicación llegó a radio y televisión de Canarias
      </p>

      <p className="text-sm sm:text-base text-[#6b7280] max-w-[700px] mx-auto mb-6 sm:mb-8 px-2">
      ...
      <div className="inline-flex items-center gap-2 text-xs sm:text-sm text-[#6b7280] bg-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-full border border-[#e5e7eb]">
