export const Footer = () => {
  return (
    <div className="bg-white border-t border-[#f3f4f6] py-6 px-6">
      <div className="max-w-[1100px] my-0 mx-auto">
        {/* Primera fila: Logo y copyright */}
        <div className="flex justify-between items-start flex-wrap gap-6 mb-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-[#9ca3af] text-sm">© 2025 MMI Analytics</span>
          </div>

          <div className="flex flex-wrap gap-6">
            <a
              href="#"
              className="text-[#9ca3af] text-sm no-underline hover:text-[#6b7280] transition-colors duration-200"
              onClick={(e) => {
                e.preventDefault();
